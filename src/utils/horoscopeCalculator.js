...
const RASHI_VEDIC = {
  0:  { gemstone: { te: 'పగడం (Coral)', en: 'Red Coral' }, gemstoneAlt: { te: 'కెంపు (Ruby)', en: 'Ruby' }, metal: { te: 'రాగి', en: 'Copper' }, luckyDay: { te: 'మంగళవారం', en: 'Tuesday' }, luckyColor: { te: 'ఎరుపు', en: 'Red' }, direction: { te: 'తూర్పు', en: 'East' }, mantra: 'ఓం అం అంగారకాయ నమః', deity: { te: 'హనుమాన్', en: 'Hanuman' }, bodyPart: { te: 'తల, మెదడు', en: 'Head, Brain' }, element: { te: 'అగ్ని', en: 'Fire' }, remedy: { te: 'మంగళవారం హనుమాన్ చాలీసా పారాయణం, ఎరుపు పూలతో పూజ చేయండి. పగడపు ఉంగరం అనామిక వేలుకి ధరించండి.', en: 'Recite Hanuman Chalisa on Tuesday and offer red flowers in worship. Wear a red coral ring on the ring finger.' } },
  1:  { gemstone: { te: 'వజ్రం (Diamond)', en: 'Diamond' }, gemstoneAlt: { te: 'పచ్చ (Emerald)', en: 'Emerald' }, metal: { te: 'వెండి', en: 'Silver' }, luckyDay: { te: 'శుక్రవారం', en: 'Friday' }, luckyColor: { te: 'తెలుపు', en: 'White' }, direction: { te: 'ఆగ్నేయం', en: 'South-East' }, mantra: 'ఓం శుం శుక్రాయ నమః', deity: { te: 'లక్ష్మీ దేవి', en: 'Goddess Lakshmi' }, bodyPart: { te: 'ముఖం, గొంతు', en: 'Face, Throat' }, element: { te: 'భూమి', en: 'Earth' }, remedy: { te: 'శుక్రవారం లక్ష్మీ పూజ, తెల్లని వస్త్రాలు ధరించడం శుభకరం. వజ్ర ఉంగరం అనామిక వేలుకి ధరించండి.', en: 'Friday Lakshmi Puja and wearing white clothes are auspicious. Wear a diamond ring on the ring finger.' } },
  2:  { gemstone: { te: 'పచ్చ (Emerald)', en: 'Emerald' }, gemstoneAlt: { te: 'పెరిడాట్', en: 'Peridot' }, metal: { te: 'కంచు', en: 'Bronze' }, luckyDay: { te: 'బుధవారం', en: 'Wednesday' }, luckyColor: { te: 'ఆకుపచ్చ', en: 'Green' }, direction: { te: 'ఉత్తరం', en: 'North' }, mantra: 'ఓం బుం బుధాయ నమః', deity: { te: 'విష్ణువు', en: 'Lord Vishnu' }, bodyPart: { te: 'భుజాలు, ఊపిరితిత్తులు', en: 'Shoulders, Lungs' }, element: { te: 'వాయువు', en: 'Air' }, remedy: { te: 'బుధవారం విష్ణు సహస్రనామం పారాయణం, ఆకుపచ్చ మూంగ్ దాల్ దానం చేయండి. పచ్చ ఉంగరం చిటికెన వేలుకి ధరించండి.', en: 'Recite Vishnu Sahasranamam on Wednesday and donate green moong dal. Wear an emerald ring on the little finger.' } },
  3:  { gemstone: { te: 'ముత్యం (Pearl)', en: 'Pearl' }, gemstoneAlt: { te: 'మూన్‌స్టోన్', en: 'Moonstone' }, metal: { te: 'వెండి', en: 'Silver' }, luckyDay: { te: 'సోమవారం', en: 'Monday' }, luckyColor: { te: 'తెలుపు', en: 'White' }, direction: { te: 'వాయవ్యం', en: 'North-West' }, mantra: 'ఓం చం చంద్రాయ నమః', deity: { te: 'శివుడు', en: 'Lord Shiva' }, bodyPart: { te: 'ఛాతి, కడుపు', en: 'Chest, Stomach' }, element: { te: 'నీరు', en: 'Water' }, remedy: { te: 'సోమవారం శివ అభిషేకం, తెల్లని పువ్వులు సమర్పించండి. ముత్యపు ఉంగరం అనామిక వేలుకి ధరించండి.', en: 'Perform Shiva Abhishekam on Monday and offer white flowers. Wear a pearl ring on the ring finger.' } },
  4:  { gemstone: { te: 'కెంపు (Ruby)', en: 'Ruby' }, gemstoneAlt: { te: 'గార్నెట్', en: 'Garnet' }, metal: { te: 'బంగారం', en: 'Gold' }, luckyDay: { te: 'ఆదివారం', en: 'Sunday' }, luckyColor: { te: 'నారింజ', en: 'Orange' }, direction: { te: 'తూర్పు', en: 'East' }, mantra: 'ఓం సూం సూర్యాయ నమః', deity: { te: 'సూర్య భగవానుడు', en: 'Sun God' }, bodyPart: { te: 'హృదయం, వెన్నెముక', en: 'Heart, Spine' }, element: { te: 'అగ్ని', en: 'Fire' }, remedy: { te: 'ఆదివారం సూర్య నమస్కారాలు, ఆదిత్య హృదయం పారాయణం. కెంపు ఉంగరం అనామిక వేలుకి బంగారంలో ధరించండి.', en: 'Practise Surya Namaskar and recite Aditya Hridayam on Sunday. Wear a ruby ring set in gold on the ring finger.' } },
  5:  { gemstone: { te: 'పచ్చ (Emerald)', en: 'Emerald' }, gemstoneAlt: { te: 'పెరిడాట్', en: 'Peridot' }, metal: { te: 'కంచు', en: 'Bronze' }, luckyDay: { te: 'బుధవారం', en: 'Wednesday' }, luckyColor: { te: 'ఆకుపచ్చ', en: 'Green' }, direction: { te: 'దక్షిణం', en: 'South' }, mantra: 'ఓం బుం బుధాయ నమః', deity: { te: 'గణేశుడు', en: 'Lord Ganesha' }, bodyPart: { te: 'ఉదరం, ప్రేగులు', en: 'Abdomen, Intestines' }, element: { te: 'భూమి', en: 'Earth' }, remedy: { te: 'బుధవారం గణేశ పూజ, ఆకుపచ్చ బియ్యం దానం. పచ్చ ఉంగరం చిటికెన వేలుకి ధరించండి.', en: 'Wednesday Ganesha Puja and donating green rice are auspicious. Wear an emerald ring on the little finger.' } },
  6:  { gemstone: { te: 'వజ్రం (Diamond)', en: 'Diamond' }, gemstoneAlt: { te: 'వైట్ సఫైర్', en: 'White Sapphire' }, metal: { te: 'వెండి', en: 'Silver' }, luckyDay: { te: 'శుక్రవారం', en: 'Friday' }, luckyColor: { te: 'తెలుపు', en: 'White' }, direction: { te: 'పశ్చిమం', en: 'West' }, mantra: 'ఓం శుం శుక్రాయ నమః', deity: { te: 'లక్ష్మీ దేవి', en: 'Goddess Lakshmi' }, bodyPart: { te: 'మూత్రపిండాలు, నడుము', en: 'Kidneys, Lower Back' }, element: { te: 'వాయువు', en: 'Air' }, remedy: { te: 'శుక్రవారం శ్రీ సూక్తం పారాయణం, తెలుపు వస్తువులు దానం. వజ్ర ఉంగరం అనామిక వేలుకి ధరించండి.', en: 'Recite Sri Suktam on Friday and donate white items. Wear a diamond ring on the ring finger.' } },
  7:  { gemstone: { te: 'పగడం (Coral)', en: 'Red Coral' }, gemstoneAlt: { te: 'గార్నెట్', en: 'Garnet' }, metal: { te: 'రాగి', en: 'Copper' }, luckyDay: { te: 'మంగళవారం', en: 'Tuesday' }, luckyColor: { te: 'ఎరుపు', en: 'Red' }, direction: { te: 'దక్షిణం', en: 'South' }, mantra: 'ఓం అం అంగారకాయ నమః', deity: { te: 'శివుడు', en: 'Lord Shiva' }, bodyPart: { te: 'జననేంద్రియాలు', en: 'Reproductive Organs' }, element: { te: 'నీరు', en: 'Water' }, remedy: { te: 'మంగళవారం శివ పూజ, మహామృత్యుంజయ మంత్ర జపం. పగడపు ఉంగరం అనామిక వేలుకి రాగిలో ధరించండి.', en: 'Tuesday Shiva Puja and chanting of the Maha Mrityunjaya Mantra. Wear a red coral ring set in copper on the ring finger.' } },
  8:  { gemstone: { te: 'పుష్యరాగం (Yellow Sapphire)', en: 'Yellow Sapphire' }, gemstoneAlt: { te: 'సిట్రిన్', en: 'Citrine' }, metal: { te: 'బంగారం', en: 'Gold' }, luckyDay: { te: 'గురువారం', en: 'Thursday' }, luckyColor: { te: 'పసుపు', en: 'Yellow' }, direction: { te: 'ఈశాన్యం', en: 'North-East' }, mantra: 'ఓం బృం బృహస్పతయే నమః', deity: { te: 'దత్తాత్రేయ', en: 'Lord Dattatreya' }, bodyPart: { te: 'తొడలు, కాలేయం', en: 'Thighs, Liver' }, element: { te: 'అగ్ని', en: 'Fire' }, remedy: { te: 'గురువారం పసుపు వస్త్రాలు ధరించి దత్తాత్రేయ స్తోత్రం పఠించండి. పుష్యరాగం చూపుడు వేలుకి బంగారంలో ధరించండి.', en: 'Wear yellow clothes and recite Dattatreya Stotram on Thursday. Wear a yellow sapphire set in gold on the index finger.' } },
  9:  { gemstone: { te: 'నీలం (Blue Sapphire)', en: 'Blue Sapphire' }, gemstoneAlt: { te: 'అమెథిస్ట్', en: 'Amethyst' }, metal: { te: 'ఇనుము', en: 'Iron' }, luckyDay: { te: 'శనివారం', en: 'Saturday' }, luckyColor: { te: 'నీలం', en: 'Blue/Black' }, direction: { te: 'పశ్చిమం', en: 'West' }, mantra: 'ఓం శం శనైశ్చరాయ నమః', deity: { te: 'హనుమాన్', en: 'Hanuman' }, bodyPart: { te: 'మోకాళ్ళు, ఎముకలు', en: 'Knees, Bones' }, element: { te: 'భూమి', en: 'Earth' }, remedy: { te: 'శనివారం హనుమాన్ చాలీసా, నల్లని తిల దానం. నీలం రత్నం మధ్యవేలుకి ఇనుములో ధరించండి (పరీక్షించిన తర్వాత మాత్రమే).', en: 'Recite Hanuman Chalisa on Saturday and donate black sesame seeds. Wear blue sapphire set in iron on the middle finger (only after a trial period).' } },
  10: { gemstone: { te: 'నీలం (Blue Sapphire)', en: 'Blue Sapphire' }, gemstoneAlt: { te: 'అమెథిస్ట్', en: 'Amethyst' }, metal: { te: 'ఇనుము', en: 'Iron' }, luckyDay: { te: 'శనివారం', en: 'Saturday' }, luckyColor: { te: 'నీలం', en: 'Blue' }, direction: { te: 'పశ్చిమం', en: 'West' }, mantra: 'ఓం శం శనైశ్చరాయ నమః', deity: { te: 'శని భగవానుడు', en: 'Lord Shani' }, bodyPart: { te: 'కాళ్ళు, రక్త ప్రసరణ', en: 'Legs, Circulation' }, element: { te: 'వాయువు', en: 'Air' }, remedy: { te: 'శనివారం శని స్తోత్రం పఠించి, నల్లని వస్తువులు దానం చేయండి. గాయత్రి మంత్ర జపం మేధాశక్తిని పెంచుతుంది.', en: 'Recite Shani Stotram on Saturday and donate black items. Gayatri Mantra japa enhances intellectual power.' } },
  11: { gemstone: { te: 'పుష్యరాగం (Yellow Sapphire)', en: 'Yellow Sapphire' }, gemstoneAlt: { te: 'అక్వామెరిన్', en: 'Aquamarine' }, metal: { te: 'బంగారం', en: 'Gold' }, luckyDay: { te: 'గురువారం', en: 'Thursday' }, luckyColor: { te: 'పసుపు', en: 'Yellow' }, direction: { te: 'ఈశాన్యం', en: 'North-East' }, mantra: 'ఓం బృం బృహస్పతయే నమః', deity: { te: 'విష్ణువు', en: 'Lord Vishnu' }, bodyPart: { te: 'పాదాలు, రోగనిరోధక శక్తి', en: 'Feet, Immune System' }, element: { te: 'నీరు', en: 'Water' }, remedy: { te: 'గురువారం విష్ణు సహస్రనామం పారాయణం, పసుపు పువ్వులు సమర్పించండి. పుష్యరాగం చూపుడు వేలుకి బంగారంలో ధరించండి.', en: 'Recite Vishnu Sahasranamam on Thursday and offer yellow flowers. Wear a yellow sapphire set in gold on the index finger.' } },
};
...
// --- Daily Forecast Templates — bilingual { te, en } per house transit ---
const DAILY_FORECASTS = [
  // 0: Same sign (1st house transit)
  { te: 'ఈ రోజు మీకు ఆత్మవిశ్వాసం ఎక్కువగా ఉంటుంది. కొత్త ప్రారంభాలకు మంచి సమయం. ఆరోగ్యం బాగుంటుంది. మీ వ్యక్తిత్వం ప్రకాశిస్తుంది.',
    en: 'Your self-confidence is high today. A good time for new beginnings. Your health is robust and your personality shines through.' },
  // 1: 2nd house
  { te: 'ఆర్థిక విషయాలలో జాగ్రత్త వహించండి. కుటుంబ సభ్యులతో మంచి సమయం గడుపుతారు. ఆహారం విషయంలో శ్రద్ధ వహించండి.',
    en: 'Be careful with financial matters today. You will spend quality time with family. Pay attention to what you eat.' },
  // 2: 3rd house
  { te: 'సోదరులు, మిత్రులతో మంచి సంబంధాలు ఏర్పడతాయి. చిన్న ప్రయాణాలు శుభప్రదం. ధైర్యంగా నిర్ణయాలు తీసుకోండి.',
    en: 'Good rapport forms with siblings and friends. Short trips are auspicious. Take decisions with courage.' },
  // 3: 4th house
  { te: 'గృహ సంబంధిత విషయాలలో శుభ వార్తలు రావచ్చు. తల్లి ఆరోగ్యం పట్ల శ్రద్ధ వహించండి. మానసిక ప్రశాంతత ఉంటుంది.',
    en: 'Good news may arrive on home-related matters. Take care of your mother\'s health. Mental peace prevails.' },
  // 4: 5th house
  { te: 'సృజనాత్మక కార్యకలాపాలకు అనుకూల సమయం. పిల్లలతో మంచి సమయం గడుపుతారు. ప్రేమ విషయాలలో అనుకూలత ఉంటుంది.',
    en: 'A favourable time for creative work. You spend quality time with children. Love matters look favourable.' },
  // 5: 6th house
  { te: 'శత్రువులపై విజయం సాధిస్తారు. ఆరోగ్య సమస్యలపై శ్రద్ధ వహించండి. న్యాయపరమైన విషయాలలో అనుకూల ఫలితాలు ఉంటాయి.',
    en: 'You triumph over adversaries. Watch your health closely. Favourable outcomes in legal matters.' },
  // 6: 7th house
  { te: 'భాగస్వామ్య సంబంధాలలో మంచి సమయం. వ్యాపార భాగస్వామ్యాలు శుభప్రదం. జీవిత భాగస్వామితో అనుబంధం బలపడుతుంది.',
    en: 'A good time for partnerships. Business alliances are auspicious. Your bond with your life partner deepens.' },
  // 7: 8th house
  { te: 'ఆరోగ్యం విషయంలో జాగ్రత్త అవసరం. అనూహ్య మార్పులు రావచ్చు. ఆధ్యాత్మిక సాధనకు మంచి సమయం. రహస్య విషయాలు బయటపడవచ్చు.',
    en: 'Be careful with health. Unexpected changes may arise. A good time for spiritual practice. Hidden matters may come to light.' },
  // 8: 9th house
  { te: 'భాగ్యోదయం ఉంటుంది. తండ్రితో మంచి సంబంధాలు. దూర ప్రయాణాలు శుభప్రదం. ధార్మిక కార్యక్రమాలలో పాల్గొనే అవకాశం.',
    en: 'Fortune favours you. Good relations with your father. Long journeys are auspicious. An opportunity to participate in religious events.' },
  // 9: 10th house
  { te: 'వృత్తిలో పురోగతి ఉంటుంది. అధికారులనుండి గుర్తింపు లభిస్తుంది. కీర్తి ప్రతిష్ఠలు పెరుగుతాయి. కొత్త బాధ్యతలు వస్తాయి.',
    en: 'Career progress is on the horizon. Recognition comes from those in authority. Fame and reputation grow. New responsibilities arrive.' },
  // 10: 11th house
  { te: 'ఆర్థిక లాభాలు ఉంటాయి. కోరికలు నెరవేరతాయి. మిత్రుల ద్వారా మంచి వార్తలు వస్తాయి. సామాజిక కార్యకలాపాలలో విజయం.',
    en: 'Financial gains are likely. Wishes are fulfilled. Good news comes through friends. Success in social activities.' },
  // 11: 12th house
  { te: 'ఖర్చులు ఎక్కువగా ఉంటాయి. నిద్రలో భంగం రావచ్చు. విదేశీ సంబంధిత విషయాలకు అనుకూలం. ఆధ్యాత్మిక చింతన మంచి ఫలితాలు ఇస్తుంది.',
    en: 'Expenses run high. Sleep may be disturbed. Favourable for foreign-related matters. Spiritual contemplation yields good results.' },
];
...
function generateDailyForecast(birthRashiIndex) {
  ...
  return {
    te: `చంద్రుడు ప్రస్తుతం ${transitRashi.telugu} రాశిలో సంచరిస్తున్నారు. ${forecast.te}`,
    en: `The Moon is currently transiting through ${transitRashi.english}. ${forecast.en}`,
  };
}
