...
const s = StyleSheet.create({
  ...
  cardTitle: { fontWeight: '700', color: DarkColors.gold, textAlign: 'center' },
  ...
  otpInput: { fontWeight: '600', letterSpacing: 8 },
  ...
  tierText: { fontWeight: '700', letterSpacing: 1 },
  ...
  upgradeText: { fontWeight: '600', color: DarkColors.goldShimmer },
  logoutBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
    marginTop: 12, borderRadius: 12,
